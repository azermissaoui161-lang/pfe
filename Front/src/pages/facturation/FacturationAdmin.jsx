              ...
              return (
                <div key={r.id} className="report-card detailed">
                  ...
                  <div className="report-card-footer">
                    ...
                    <button className="btn-outline" onClick={()=>handleDownloadReport(r)}>⬇️ Télécharger</button>
                    <button className="btn-icon" onClick={()=>openModal('report',r)}>✏️</button>
                    <button className="btn-icon" onClick={()=>handleDeleteReport(r.id,r.title)}>🗑️</button>
                  </div>
                </div>
              )
            })}
        ...
        <div className="modal-overlay" onClick={()=>setReportModal({ show: false, report: null })}>
          <div className="modal-content modal-large" onClick={e=>e.stopPropagation()}>
            ...
            <div className="modal-body">
              <div className="report-view-header">
                <div className="report-meta-info">
                  ...
                  <span>🏷️ Type: {reportModal.report.type}</span>
            ...
            <div className="modal-footer">
              ...
              <button className="btn-primary" onClick={()=>handleDownloadReport(reportModal.report)}>⬇️ Télécharger PDF</button>
            </div>
          </div>
        </div>
      )}
