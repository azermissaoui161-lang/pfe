...
function FinanceAdmin() {
  ...
  // ── NEW: state for the "view full content" modal ──
                ...
                <div key={r.id} className="report-card">
                  ...
                  <div className="report-actions">
                    ...
                    <button
                      ...
                      onClick={() => {
                        showNotif("Génération du PDF en cours...", "info");
                        setTimeout(() => {
                          exportReportToPDF(r, formatDate, formatDateTime);
                          showNotif(" téléchargement");
                        }, 300);
                      }}
                    >PDF</button>
