...
// @desc    Rechercher des utilisateurs (admin)
...
// @desc    Récupérer la liste des rôles disponibles (admin)
// @route   GET /api/users/roles
exports.getRoles = async (req, res) => {
  try {
    const roles = [
      { value: 'admin_principal', label: 'Administrateur Principal' },
      { value: 'admin_finance', label: 'Administrateur Finance' },
      { value: 'admin_stock', label: 'Administrateur Stock' },
      { value: 'admin_facture', label: 'Administrateur Facturation' },
